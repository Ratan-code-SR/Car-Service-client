    ...
    return (
        <div className="my-5">
            <div className="w-2/5 mx-auto text-center">
                ...
                <p className="text-sm text-gray-400">the majority have suffered alteration in some form, by injected humour, or randomised words which do not look even slightly believable.</p>
            </div>
